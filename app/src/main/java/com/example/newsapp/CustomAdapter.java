...
public class CustomAdapter extends RecyclerView.Adapter<CustomViewHolder> {
    ...
    public CustomAdapter(Context context, List<NewsHeadlines> headlines, SelectLestener lestener) {
    ...
    public void onBindViewHolder(@NonNull CustomViewHolder holder, int position) {
        ...
        if (headlines.get(position).getUriToImage() != null) {
            Picasso.get().load(headlines.get(position).getUriToImage()).into(holder.img_headline);
        }
